      ...
      <div>
        <section className="lp-content lp-content--intro">
          <div className="container clearfix">
            <p>
              SpeakAbility is an app created specifically for people
              with intermediate and upper-intermediate language levels to train
        ...
        <section className="lp-content lp-content--benefit lp-content--situations">
          <div className="container clearfix">
            ...
            <p>
              We use quests to help you dive into real-life situations, so the
              process is fun and interactive
            </p>
        ...
        <section className="lp-content lp-content--benefit lp-content--feedback">
          <div className="container clearfix">
            <h2>Feedback</h2>
            <p>
              We are using speach recognition instruments to give you a feedback
              on your replies
            </p>
        ...
        <section className="lp-content lp-content--features">
          <div className="container clearfix">
            <p className="feature feature--comfort">
              Practice your English speaking skills anytime, anywhere
            </p>
            <p className="feature feature--vr">
              Use VR extention to dive into the experience
            </p>
            <p className="feature feature--savings">
              No need to spend time or money to get to language clubs or courses
            </p>
          </div>
        </section>
        ...
        <section className="lp-content lp-content--cta">
          ...
          <a
            href="Register"
            className="btn btn-primary btn-cta btn-cta--header"
          >
            Try demo for free
          </a>
        </section>
        ...
        <footer className="footer">
          <div className="container clearfix">
            <nav className="footer__nav footer__nav--lp">
              <ul>
                <li>
                  <a href="mailto: hi@speakability.co">hi@speakability.co</a>
                </li>
              </ul>
            </nav>
          </div>
