      ...
      return (
        <main className="container clearfix">                
          ...
          <section className="congrats">
              ...
              <p className="text-secondary">{this.props.conversation.congratulation}</p>
              <a href={"/Map/" + this.props.map_obj._id} className="btn btn-cta btn-primary">To the next location</a>
          </section>
        </main>
        );
    }
